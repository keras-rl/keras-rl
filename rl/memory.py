...
class PartitionedMemory(Memory):
    ...
    def update_priorities(self, idxs, priorities, partitioned_boost=.999):
        """
        adjust priorities based on new TD error. paritioned_boost is constant val
        to add to permanent data priorities.
        """
        for i, idx in enumerate(idxs):
            assert 0 <= idx < self.limit
